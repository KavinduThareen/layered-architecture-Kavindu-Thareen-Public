...
import static com.example.layeredarchitecture.dao.DAOFactory.DAOType.*;

public class PlaseorderOBImpl implements PlaseorderOB {
    ...
    QueryDAO queryDAO= (QueryDAO) DAOFactory.getDaoFactory().getDAO(QUERY);
    @Override
