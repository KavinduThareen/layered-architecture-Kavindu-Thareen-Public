...
import static com.example.layeredarchitecture.bo.BOFactory.BoType.ITEM;
...
public class ManageItemsFormController {
    ...
    ItemBOImpl itemBO = (ItemBOImpl) BOFactory.getDaoFactory().getBO(ITEM);
