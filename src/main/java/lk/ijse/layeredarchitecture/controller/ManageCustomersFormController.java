...
import static lk.ijse.layeredarchitecture.bo.BOFactory.BoType.CUSTOMER;
...
public class ManageCustomersFormController {
   ...
   // CustomerDAO customerDAO=new CustomerDAOImpl();
    CustomerBOImpl customerBO = (CustomerBOImpl) BOFactory.getDaoFactory().getBO(CUSTOMER);
    ...
    private void loadAllCustomers() {
        ...
        /*Get all customers*/
        try {
            ArrayList<CustomerDTO> allCustomer = customerBO.getAllCus();
    ...
    public void btnSave_OnAction(ActionEvent actionEvent) {
        ...
        if (btnSave.getText().equalsIgnoreCase("save")) {
            ...
            try {
                ...
                boolean isSaved = customerBO.saveCus(new CustomerDTO(id, name, address));
    ...
    private String generateNewId() {
        try {
            return customerBO.generateIDCus();
        } catch (SQLException e) {
